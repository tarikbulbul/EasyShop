const BenifitCard = ({ benifit }) => {
    return (
        <div className="p-10 hover:border-lime-400 font-Poppins bg-white shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 rounded-lg border flex items-start justify-between space-x-2">
